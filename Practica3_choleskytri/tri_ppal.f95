...
real, dimension(:), allocatable :: a, a_copia, b, b_copia,r, w,u, res
...
allocate(a(n), b(2:n), r(n), w(n), u(n), a_copia(n), b_copia(n), res(n))
...
call residuotri(a_copia, b_copia, b_copia, u, r, res)
